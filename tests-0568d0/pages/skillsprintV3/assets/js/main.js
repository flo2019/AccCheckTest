(function(){
  ...
  if (menuToggle && mainNav) {
    ...
    //setExpanded(false);
    //menuToggle.addEventListener('click', () => setExpanded(menuToggle.getAttribute('aria-expanded') !== 'false'));
    //smainNav.addEventListener('keyup', (e) => { if (e.key === 'Escape') setExpanded(true); });
    //menuToggle.addEventListener('click', () => {
    //const expanded = menuToggle.getAttribute('aria-expanded') === 'true';
    // Nur ARIA-State ändern – DOM unverändert, nichts verstecken
    //menuToggle.setAttribute('aria-expanded', String(!expanded));
    //mainNav.setAttribute('aria-expanded', String(!expanded)); // rein dekorativ
  //});
